...
with open('hyper/optuna_study.pkl', 'wb') as f:
    pickle.dump(study, f)
...
torch.save(best_model_ResNet_IF.state_dict(), 'hyper/best_model_ResNet_IF.pth')
torch.save(best_model_ResNet_IFOF.state_dict(), 'hyper/best_model_ResNet_IFOF.pth')
torch.save(best_model_EfficientNet_IF.state_dict(), 'hyper/best_model_EfficientNet_IF.pth')
torch.save(best_model_EfficientNet_IFOF.state_dict(), 'hyper/best_model_EfficientNet_IFOF.pth')

# Save each best history to a .pkl file
with open('hyper/best_history_ResNet_IF.pkl', 'wb') as f:
    pickle.dump(best_history_ResNet_IF, f)

with open('hyper/best_history_ResNet_IFOF.pkl', 'wb') as f:
    pickle.dump(best_history_ResNet_IFOF, f)

with open('hyper/best_history_EfficientNet_IF.pkl', 'wb') as f:
    pickle.dump(best_history_EfficientNet_IF, f)

with open('hyper/best_history_EfficientNet_IFOF.pkl', 'wb') as f:
