...
def objective(trial):
    ...
    val_loss_avg = val_loss_efficientnet_IF
...
with open('hyper-1/optuna_study_freeze_IF-2.pkl', 'wb') as f:
    pickle.dump(study, f)
...
# torch.save(best_model_ResNet_IF.state_dict(), 'hyper-1/best_Fmodel_ResNet_IF.pth')
# torch.save(best_model_ResNet_IFOF.state_dict(), 'hyper-1/best_Fmodel_ResNet_IFOF.pth')
torch.save(best_model_EfficientNet_IF.state_dict(), 'hyper-1/best_Fmodel_EfficientNet_IF.pth')
# torch.save(best_model_EfficientNet_IFOF.state_dict(), 'hyper-1/best_Fmodel_EfficientNet_IFOF.pth')

# Save each best history to a .pkl file
# with open('hyper-1/best_Fhistory_ResNet_IF.pkl', 'wb') as f:
#     pickle.dump(best_history_ResNet_IF, f)

# with open('hyper-1/best_Fhistory_ResNet_IFOF.pkl', 'wb') as f:
#     pickle.dump(best_history_ResNet_IFOF, f)

with open('hyper-1/best_Fhistory_EfficientNet_IF.pkl', 'wb') as f:
    pickle.dump(best_history_EfficientNet_IF, f)

# with open('hyper-1/best_Fhistory_EfficientNet_IFOF.pkl', 'wb') as f:
